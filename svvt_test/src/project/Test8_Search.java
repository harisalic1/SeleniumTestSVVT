...
class Test8_Search {
	...
	void test() throws InterruptedException {
		...
		webDriver.findElement(By.xpath("/html/body/div[7]/div[3]/div/div[1]/div[3]/header/div[2]/div[2]/div[2]")).click();
		
		Thread.sleep(3000);
		
		webDriver.findElement(By.xpath("/html/body/div[7]/div[3]/div/div[1]/div[3]/header/div[2]/div[2]/div[2]/form/div[1]/table/tbody/tr/td/table/tbody/tr/td/div/input[1]")).sendKeys("naida.kokic@izvornade.com ");
		
		Thread.sleep(3000);
		
		webDriver.findElement(By.xpath("/html/body/div[7]/div[3]/div/div[1]/div[3]/header/div[2]/div[2]/div[2]/form/button[4]")).click();
