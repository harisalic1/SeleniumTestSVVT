...
class Test3_Send {
	...
	void test() throws InterruptedException {
		...
		Thread.sleep(5000);
		//Navigating to All Mail folder
		
		webDriver.findElement(By.xpath("/html/body/div[7]/div[3]/div/div[2]/div[2]/div[1]/div[2]/div/div/div/div/div[2]/div/div/div[2]/span")).click();
		
		Thread.sleep(3000);
		
		webDriver.findElement(By.linkText("All Mail")).click();
